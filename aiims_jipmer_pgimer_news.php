                  ...
                  <div class="item">
                    ...
                    <div class="cover">
                        <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
                            <h1>AIIMS/ JIPMER/ PGIMER News</h1>
    ...
    <section class="inner-page">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12">
             <table id="table_id" class="display" style="width: 100%;border-style: none">
            <thead>
                <tr>
                    <th>Sr.No</th>
                    <th>News</th>
            ...
            <tbody>
              <?php
                            $query = "SELECT * FROM `tbl_news` where news_for='AIIMS' OR news_for='PGIMER'  OR news_for='JIPMER' ORDER BY news_date DESC"; 
     ...
     <div id="WAButton"></div>  
 <div style="width: 150px;position: fixed;bottom:15px;left:15px;"><a href="tel:18002663555"><img src="assets/img/calling.png" height="70px" width="70px;"></a></div>
  </main><!-- End #main -->
<?php
  include("footer.php");
?>
