...
?>
     ...
     <section id="link" class="link" style="height:85px" >
         <div class="row">
              <img alt="" class="img-fluid" src="admin/upload/AIIMS.jpg" height="100px" width="100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="row">  
               <h2 style="font-size:18px">state medical council</h2>
           </div>
         </div>
    </section>
     <!-- ======= Portfolio Section ======= -->
