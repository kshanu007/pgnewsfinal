...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
            <div class="container text-center position-relative">
               <div class="owl-carousel owl-theme">
                            ...
                            <div class="col-md-12 row" style="justify-content: center;">
                              <div class="col-md-8">
                                   <div class="input-group-prepend" >
                                        <input type="text" class="form-control" id="search" onclick="open_search();"  aria-label="Small" placeholder="Search Top Medical College...." />
                                        <span class="input-group-text fa fa-search" id="inputGroup-sizing-sm" onclick="open_search();" style="background-color: green;color:white"></span>
                                 </div>
                                
                              </div>
                            </div>
                            <hr>
                             <a href="#" data-toggle="modal" data-target="#myModal2" class="btn-get-started btn-success" style="border-color: #28a745;">AIIMS</a>
                            <a href="#" data-toggle="modal" data-target="#myModal3"  class="btn-get-started btn-success" style="border-color: #28a745;">MCC</a>
                            <a href="#" data-toggle="modal" data-target="#myModal4"  class="btn-get-started btn-success" style="border-color: #28a745;">JIPMER</a>
                             <a href="#" data-toggle="modal" data-target="#myModal5"  class="btn-get-started btn-success" style="border-color: #28a745;">PGIMER</a>
                            <a href="#" data-toggle="modal" data-target="#myModal6"  class="btn-get-started btn-success" style="border-color: #28a745;">NBE</a>
                         </div>
                    </div>
                </div>    
                 <div class="item">
                    ...
                    <div class="cover">
                        <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="400"><br/><br/><br/><br/>
                            ...
                            <h1>For Admission in NRI Quota</h1>
                             <a href="tel:18002663555" class="btn-get-started btn-success" style="border-color: #28a745;">Talk TO Our Expert Doc</a>
                             <hr>
                            <div class="col-md-12 row" style="justify-content: center;">
                              <div class="col-md-8">
                            ...
                            <a href="#" data-toggle="modal" data-target="#myModal4"  class="btn-get-started btn-success" style="border-color: #28a745;">JIPMER</a>
                             <a href="#" data-toggle="modal" data-target="#myModal5"  class="btn-get-started btn-success" style="border-color: #28a745;">PGIMER</a>
                            <a href="#" data-toggle="modal" data-target="#myModal6"  class="btn-get-started btn-success" style="border-color: #28a745;">NBE</a>
                            <!--<input type="text" class="form-control" name="search" placeholder="Search By College Name,City,State,Type"><hr>-->
                         </div>
                    </div>
                </div> 
                 <div class="item">
                    ...
                    <div class="cover">
                        <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="400"><br/><br/><br/><br/>
                            ...
                            <h1>Admission through Management Quota</h1>
                             <a href="tel:18002663555" class="btn-get-started btn-success" style="border-color: #28a745;">Talk TO Our Expert Doc</a>
                             <hr>
                            <div class="col-md-12 row" style="justify-content: center;">
                              <div class="col-md-8">
                ...
                <!--            <h1>Search Top Medical Colleges</h1>-->
                <!--            <input type="text" class="form-control" name="search" placeholder="Search By College Name,City,State,Type"><hr>-->
                <!--         </div>-->
                <!--    </div>-->
                <!--</div>    -->
  ...
  <main id="main">
        ...
        <section id="link" class="link" style="background:url('images/cover7.jpg');">
            <div class="section-title" data-aos="fade-right" style="padding-bottom: 0px;">
              <h2 >Welcome to pg-news</h2>
              <p style="font-size:14px">PG-News is a leading digital platform for solutions for medical education in India and Abroad.
                    We nurture the aspirations of scholars who dream of a career in medicine.<br>
                    We are offering them the simplest support and advisory so as to urge their admission to the simplest admission colleges for MBBS/PG/MS/MD etc. through various medical entrance exams or through direct admission via NRI & Management Quota Seats.
                    </p>
            </div>
    ...
    <section id="link" class="link">
            <div class="section-title" data-aos="fade-right" style="padding-bottom: 0px;">
                <div class="row">  <img alt="" class="img-fluid" src="assets/img/Final logo.png" height="50px" width="100px">&nbsp;&nbsp;
              <h2>state medical council<a href="tel:18002663555" style="color:red;font-size: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOLL FREE-18002663555</a></h2>
           </div>
            <!--<div class="section-title" data-aos="fade-right">-->
            <!--  <h2>Admission in UG/PG - 2021<a href="tel:18002663555" style="color:red;font-size: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOLL FREE-18002663555</a></h2>-->
            <!--</div>-->
                </div>
       <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <a href="https://dme.mponline.gov.in/Portal/Services/DMEMP/DMEUG/Profile/ProfileLoginHome.aspx" target="_blank" class="btn-get-started btn-success" style="border-color: #28a745;">Madhya Pradesh</a>
            ...
            <a href="https://upneet.gov.in/" target="_blank" class="btn-get-started btn-success" style="border-color: #28a745;">Uttar Pradesh</a>
            <a href="https://tnmedicalselection.net/" target="_blank" class="btn-get-started btn-success" style="border-color: #28a745;">Tamil Nadu</a>
            ...
            <a href="http://www.rajprepg2020.com/" target="_blank" class="btn-get-started btn-success" style="border-color: #28a745;">Rajasthan</a>
            <a href="https://wbmcc.nic.in/ug/HomePage.aspx" target="_blank" class="btn-get-started btn-success" style="border-color: #28a745;">West Bengal</a>
       </div>
    </section>
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                ...
                <!---------->
                 <div class="col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100" >
                  <div class="icon-box mt-4 mt-xl-0">
                    <h4 style="text-align: center;padding-top:10px;">NME & Gov./Private/Deemed</h4>
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="500" >
            <div class="owl-carousel testimonials-carousel" >
              <div class="testimonial-item">
                ...
                <h4> <a href="tel:18002663555">Click Here>>></a></h4>
              </div>
      ...
      <div class="container">
        ...
        <div class="row"  data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex align-items-stretch" data-aos="fade-right">
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100" id="first_p" style="height:520px">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-chart"></i>
                    <h4>Top Medical Colleges</h4>
                    ...
                    <!--<a style="cursor:pointer;color:#002b62;" id="show_more" >More</a>-->
                    <!--    <span style="display:none" id="first">-->
                        ...
                        Get the best advice regarding your career and admission confirmation by contacting our Counsellors.<br>
                      <!--<a style="cursor:pointer;color:#002b62;" class="pull-right" id="less_more">Less</a>-->
                    </span>
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200" id="second_p" style="height:520px">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-sort-a-z"></i>
                    <h4>Best Guidance From our counceller</h4>
                    <p>After MBBS you're your own master.
                        There is nothing called campus interviews or placement after MBBS in
                        <!--<br><a style="cursor:pointer;color:#002b62;" id="show_more2">More</a>-->
                        ...
                        Practically speaking, There are tons of vacancies available after MBBS and you'll be 100% sure of getting one it's up to your skills to urge the great and best ones.<br>
                    <!--     <a style="cursor:pointer;color:#002b62;" class="pull-right" id="less_more2">Less</a>-->
                    <!--</span>-->
                        </p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300" id="third_p" style="height:520px">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-list-ul"></i>
                    <h4>List of MD/MS Courses and Seats Available in India</h4>
                    <p>
                        <ul>
                        MD/MS Courses Total Intake (Seats) in India
                        <li>Anaesthesia 2463 seats</li>
                        <!--<a style="cursor:pointer;color:#002b62;" id="show_more3">More</a>-->
                        <!--<span style="display:none" id="third">-->
                        <li>BioChemistry(636 seats)</li>
                        <li>Community Medicine (919 seats)</li>
                        <li>Dermatology, Venerology & Leprosy (707 seats)</li>
                        <li>Forensic Medicine (415 seats)</li>
                        <li>General Medicine (3188 seats)</li>
                        <li>General Surgery (2901 seats)</li>
                        <li>Microbilogy (908 seats)</li>
                        <li>M.D./M.S. Anatomy (830 seats)</li>
                        <li>M.S. ENT (784 seats)</li>
                        <li>M.S. Orthopedics (1489 seats)</li>
                         <a style="cursor:pointer;color:#002b62;" id="show_more3">More</a>
                        <span style="display:none" id="third">
                       <li> M.D. Pathology (1533 seats)</li>
                        <li>M.D. Pediatrics (1672 seats)</li>
                        <li>M.D. Physiology(815 seats)<</li>
                        <li>M.D. Pharmacology (839 seats)</li>
                        <li>M.D. Psychiatry (652 seats)</li>
                        <li>Obstetrics & Gynaecology (2013 seats)</li>
                        <li>Ophthalmology (1174 seats)</li>
                        <li>Radiotherphy (303 seats)</li>
                        <li>Radiology/Radio Diagnosis (1212 seats)</li>
                        <li>Respiratory Medicine (491 seats)</li>
                        <br>
                         <a style="cursor:pointer;color:#002b62;" class="pull-right" id="less_more3">Less</a>
                    <!--     <br>-->
                    </span>
                    </ul>
                        </p>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          ...
          <a class="cta-btn" href="tel:18002663555">Call To Action</a>
        </div>
                               ...
                               <input type="text" name="type" id="type" style="display: none">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" id="header_image1" height="80px" width="80px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal2" style="padding-right: 10px;">
  <div class="modal-dialog modal-lg" role="urlument" style="border: 2px solid #002b62;">
    <div class="modal-content" >
     <!-- <div class="modal-header" style="margin: 0 auto;">-->
     <!--<img alt="" class="img-fluid" id="header_image1" height="300px" width="300px">-->
     <!-- </div>-->
      <div class="modal-body">
                         <form method="post">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="admin/upload/aiims_logo.png" height="50px" width="50px" style="display: block;margin-left: auto;margin-right: auto;width: 50%;">
                                        </div>
                                        <div class="col-md-9 input-group">
                                            <div class="col-md-12 form-row"><span class="title_name">Fill Up form For more info about</span></div>
                                            <div class="col-md-12 form-row"><h4 style="font-size:14px;font-weight:bold;text-aligh:justify">All India Institute Of Medical Science</h4></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="input-group-prepend" style="height:33px">
                                            <span class="input-group-text fa fa-user" id="inputGroup-sizing-sm"></span>
                                          </div>
                                          <input type="text" class="form-control" aria-label="Small" id="name2" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                          <div class="validate"></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                             <div class="input-group-prepend" style="height:33px">
                                          ...
                                          <input type="email" class="form-control" id="email2" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                                          <div class="validate"></div>
                                        </div>
                                          <div class="col-md-6 input-group">
                                               <div class="input-group-prepend" style="height:33px">
                                              ...
                                              <input type="text" class="form-control" id="number2" placeholder="Your Mobile Number" data-rule="maxlen:10" data-msg="Please enter a valid Number" />
                                              <div class="validate"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="study2" class="form-control">
                                              <option active value="">--Study In--</option>
                                              <option value="India">India</option>
                                              <option value="Abroad">Abroad</option>
                                          </select>
                                      ...
                                      <div class=" col-md-12 input-group">
                                         ...
                                         <textarea class="form-control" rows="2" data-rule="required" data-msg="Please write something for us" id="message2" placeholder="Your Enquiry"></textarea>
                                        <div class="validate"></div>
                                      </div>
                                    <div class="col-md-6 input-group ">
                                            <button type="submit" id="register2" class="form-control btn btn-sm btn-success" data-dismiss="modal">Send Enquiry</button>
                                    </div>
                              </div>
                              <!--</div>-->
                              <!--</div>-->
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal3" style="padding-right: 10px;">
  <div class="modal-dialog modal-lg" role="urlument" style="border: 2px solid #002b62;">
    <div class="modal-content" >
     <!-- <div class="modal-header" style="margin: 0 auto;">-->
     <!--<img alt="" class="img-fluid" id="header_image1" height="300px" width="300px">-->
     <!-- </div>-->
      <div class="modal-body">
                         <form method="post">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="assets/img/one.png" height="80px" width="80px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="col-md-12 form-row"><span style="font-size:18px;font-weight:bold;color:#f8cf40;">Fill Up form For more info about</span></div>
                                            <div class="col-md-12 form-row"><h4 style="font-size:14px;font-weight:bold;text-aligh:justify">Medical Counseling Committee</h4></div>
                                        </div>
                                        <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="assets/img/two.png" height="80px" width="80px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="input-group-prepend" style="height:33px">
                                            <span class="input-group-text fa fa-user" id="inputGroup-sizing-sm"></span>
                                          </div>
                                          <input type="text" class="form-control" aria-label="Small" id="name3" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                          <div class="validate"></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                             <div class="input-group-prepend" style="height:33px">
                                          ...
                                          <input type="email" class="form-control" id="email3" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                                          <div class="validate"></div>
                                        </div>
                                          <div class="col-md-6 input-group">
                                               <div class="input-group-prepend" style="height:33px">
                                              ...
                                              <input type="text" class="form-control" id="number3" placeholder="Your Mobile Number" data-rule="maxlen:10" data-msg="Please enter a valid Number" />
                                              <div class="validate"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="course3" class="form-control">
                                              <option active value="">--Select Course--</option>
                                              <option value="MBBS">MBBS</option>
                                              <option value="MS">MS</option>
                                              <option value="MD">MD</option>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="study3" class="form-control">
                                              <option active value="">--Study In--</option>
                                              <option value="India">India</option>
                                              <option value="Abroad">Abroad</option>
                                          </select>
                                      ...
                                      <div class=" col-md-12 input-group">
                                         ...
                                         <textarea class="form-control" rows="2" data-rule="required" data-msg="Please write something for us" id="message3" placeholder="Your Enquiry"></textarea>
                                        <div class="validate"></div>
                                      </div>
                                    <div class="col-md-6 input-group ">
                                            <button type="submit" id="register3" class="form-control btn btn-sm btn-success" data-dismiss="modal">Send Enquiry</button>
                                    </div>
                              </div>
                              <!--</div>-->
                              <!--</div>-->
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal4" style="padding-right: 10px;">
  <div class="modal-dialog modal-lg" role="urlument" style="border: 2px solid #002b62;">
    <div class="modal-content" >
     <!-- <div class="modal-header" style="margin: 0 auto;">-->
     <!--<img alt="" class="img-fluid" id="header_image1" height="300px" width="300px">-->
     <!-- </div>-->
      <div class="modal-body">
                         <form method="post">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="admin/upload/jipmer_logo.png" height="80px" width="80px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
                                        <div class="col-md-9 input-group">
                                            <div class="col-md-12 form-row"><span style="font-size:18px;font-weight:bold;color:#f8cf40;">Fill Up form For more info about</span></div>
                                            <div class="col-md-12 form-row"><h4 style="font-size:14px;font-weight:bold;text-aligh:justify">Jawaharlal Institute of Postgraduate Medical Education and Research</h4></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="input-group-prepend" style="height:33px">
                                            <span class="input-group-text fa fa-user" id="inputGroup-sizing-sm"></span>
                                          </div>
                                          <input type="text" class="form-control" aria-label="Small" id="name4" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                          <div class="validate"></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                             <div class="input-group-prepend" style="height:33px">
                                          ...
                                          <input type="email" class="form-control" id="email4" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                                          <div class="validate"></div>
                                        </div>
                                          <div class="col-md-6 input-group">
                                               <div class="input-group-prepend" style="height:33px">
                                              ...
                                              <input type="text" class="form-control" id="number4" placeholder="Your Mobile Number" data-rule="maxlen:10" data-msg="Please enter a valid Number" />
                                              <div class="validate"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="course4" class="form-control">
                                              <option active value="">--Select Course--</option>
                                              <option value="MBBS">MBBS</option>
                                              <option value="MS">MS</option>
                                              <option value="MD">MD</option>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="study4" class="form-control">
                                              <option active value="">--Study In--</option>
                                              <option value="India">India</option>
                                              <option value="Abroad">Abroad</option>
                                          </select>
                                      ...
                                      <div class=" col-md-12 input-group">
                                         ...
                                         <textarea class="form-control" rows="2" data-rule="required" data-msg="Please write something for us" id="message4" placeholder="Your Enquiry"></textarea>
                                        <div class="validate"></div>
                                      </div>
                                    <div class="col-md-6 input-group ">
                                            <button type="submit" id="register4" class="form-control btn btn-sm btn-success" data-dismiss="modal">Send Enquiry</button>
                                    </div>
                              </div>
                              <!--</div>-->
                              <!--</div>-->
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal5" style="padding-right: 10px;">
  <div class="modal-dialog modal-lg" role="urlument" style="border: 2px solid #002b62;">
    <div class="modal-content" >
     <!-- <div class="modal-header" style="margin: 0 auto;">-->
     <!--<img alt="" class="img-fluid" id="header_image1" height="300px" width="300px">-->
     <!-- </div>-->
      <div class="modal-body">
                         <form method="post">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="admin/upload/pgimer.jpg" height="100px" width="100px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
                                        <div class="col-md-9 input-group">
                                            <div class="col-md-12 form-row"><span style="font-size:18px;font-weight:bold;color:#f8cf40;">Fill Up form For more info about</span></div>
                                            <div class="col-md-12 form-row"><h4 style="font-size:14px;font-weight:bold;text-aligh:justify">Post Graduate Institute of Medical Education & Research</h4></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="input-group-prepend" style="height:33px">
                                            <span class="input-group-text fa fa-user" id="inputGroup-sizing-sm"></span>
                                          </div>
                                          <input type="text" class="form-control" aria-label="Small" id="name5" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                          <div class="validate"></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                             <div class="input-group-prepend" style="height:33px">
                                          ...
                                          <input type="email" class="form-control" id="email5" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                                          <div class="validate"></div>
                                        </div>
                                          <div class="col-md-6 input-group">
                                               <div class="input-group-prepend" style="height:33px">
                                              ...
                                              <input type="text" class="form-control" id="number5" placeholder="Your Mobile Number" data-rule="maxlen:10" data-msg="Please enter a valid Number" />
                                              <div class="validate"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="course5" class="form-control">
                                              <option active value="">--Select Course--</option>
                                              <option value="MBBS">MBBS</option>
                                              <option value="MS">MS</option>
                                              <option value="MD">MD</option>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="study5" class="form-control">
                                              <option active value="">--Study In--</option>
                                              <option value="India">India</option>
                                              <option value="Abroad">Abroad</option>
                                          </select>
                                      ...
                                      <div class=" col-md-12 input-group">
                                         ...
                                         <textarea class="form-control" rows="2" data-rule="required" data-msg="Please write something for us" id="message5" placeholder="Your Enquiry"></textarea>
                                        <div class="validate"></div>
                                      </div>
                                    <div class="col-md-6 input-group ">
                                            <button type="submit" id="register5" class="form-control btn btn-sm btn-success" data-dismiss="modal">Send Enquiry</button>
                                    </div>
                              </div>
                              <!--</div>-->
                              <!--</div>-->
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal6" style="padding-right: 10px;">
  <div class="modal-dialog modal-lg" role="urlument" style="border: 2px solid #002b62;">
    <div class="modal-content" >
     <!-- <div class="modal-header" style="margin: 0 auto;">-->
     <!--<img alt="" class="img-fluid" id="header_image1" height="300px" width="300px">-->
     <!-- </div>-->
      <div class="modal-body">
                         <form method="post">
                                      <div class="col-md-12 form-row row justify-content-center">
                                         <div class="col-md-3 input-group">
                                             <img alt="" class="img-fluid" src="admin/upload/nbe.jpg" height="80px" width="80px" style="display: block;margin-left: auto;margin-right: auto;">
                                        </div>
                                        <div class="col-md-9 input-group">
                                            <div class="col-md-12 form-row"><span style="font-size:18px;font-weight:bold;color:#f8cf40;">Fill Up form For more info about</span></div>
                                            <div class="col-md-12 form-row"><h4 style="font-size:14px;font-weight:bold;text-aligh:justify">National Board of Examinations</h4></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                            <div class="input-group-prepend" style="height:33px">
                                            <span class="input-group-text fa fa-user" id="inputGroup-sizing-sm"></span>
                                          </div>
                                          <input type="text" class="form-control" aria-label="Small" id="name6" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                          <div class="validate"></div>
                                        </div>
                                        <div class="col-md-6 input-group">
                                             <div class="input-group-prepend" style="height:33px">
                                          ...
                                          <input type="email" class="form-control" id="email6" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                                          <div class="validate"></div>
                                        </div>
                                          <div class="col-md-6 input-group">
                                               <div class="input-group-prepend" style="height:33px">
                                              ...
                                              <input type="text" class="form-control" id="number6" placeholder="Your Mobile Number" data-rule="maxlen:10" data-msg="Please enter a valid Number" />
                                              <div class="validate"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 input-group">
                                          ...
                                          <select name="course6" class="form-control">
                                              <option active value="">--Select Course--</option>
                                              <option value="MBBS">MBBS</option>
                                              <option value="MS">MS</option>
                                              <option value="MD">MD</option>
                                      ...
                                      <div class=" col-md-12 input-group">
                                         ...
                                         <textarea class="form-control" rows="2" data-rule="required" data-msg="Please write something for us" id="message6" placeholder="Your Enquiry"></textarea>
                                        <div class="validate"></div>
                                      </div>
                                    <div class="col-md-6 input-group ">
                                            <button type="submit" id="register6" class="form-control btn btn-sm btn-success" data-dismiss="modal">Send Enquiry</button>
                                    </div>
                              </div>
                              <!--</div>-->
                              <!--</div>-->
  ...
  <div class="modal fade right" id="search_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalPreviewLabel" aria-hidden="true">
    <div class="modal-dialog-full-width modal-dialog momodel modal-fluid" role="document">
        <div class="modal-content-full-width modal-content ">
            <div class=" modal-header-full-width   modal-header text-center">
                <div class="input-group-prepend" style="height:45px">
                    <span class="input-group-text fa fa-search" id="inputGroup-sizing-sm"></span>
                </div>
                <input type="text" class="form-control" style="font-size:20px" aria-label="Small" name="search_query" id="search_query" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
            </div>
            <div class="modal-body result_search" id="result_search">
 ...
 <div class="calling"><a href="tel:18002663555"><img src="assets/img/calling.png"></a></div>
  </main><!-- End #main -->
  <?php
include("footer.php");
?>
<script type="application/javascript">
  ...
  $(document).ready(function(){
   ...
   $('#register').on('click', function() {
        ...
        var type =$('#type').val();
        if(name!="" && email!="" && message!="" && number!="" && course!="" && study!=""){
           $.ajax({
                type: "POST",
                async:false,
                url: "db/insert.php",
      ...
      $('#register5').on('click', function() {
        ...
        var course =$('#course5').val();
        var study =$('#study5').val();
        var type ='PGIMER';
        if(name!="" && email!="" && message!="" && number!="" && course!="" && study!=""){
           $.ajax({
                type: "POST",
      ...
      $('#register6').on('click', function() {
        var name =$('#name6').val();
        var email =$('#email6').val();
        var message =$('#message6').val();
        var number =$('#number6').val();
        var course =$('#course6').val();
        var study =$('#study6').val();
        var type ='NBE';
        if(name!="" && email!="" && message!="" && number!="" && course!="" && study!=""){
           $.ajax({
                type: "POST",
  ...
  $('.owl-carousel').owlCarousel({
    ...
    nav:true,
    mouseDrag:true,
    autoplay:$(".owl-theme > .item").length > 1 ? 5000 : false,
...
$('.testimonial-item').on('mouseleave',function(e){
 ...
 $(document).ready(function () {
        $('#show_more').click(function () {
            ...
            $("#first_p").animate({ height: '800px' }, 500);
            $('#show_more').hide();
            $('#first').show();          // Also show the div element.
        });

        // Reverse animate.
        $('#less_more').click(function () {
            $("#first_p").animate({ height: '300px' }, 500);
            $('#first').hide('slow');          // Now hide the div.
            $('#show_more').show();
        });
        
         $('#show_more2').click(function () {
            // Animate the div element. A duration is set to 500 milliseconds.
            $("#second_p").animate({ height: '800px' }, 500);
            $('#show_more2').hide();
            $('#second').show();          // Also show the div element.
        });

        // Reverse animate.
        $('#less_more2').click(function () {
            $("#second_p").animate({ height: '300px' }, 500);
            $('#second').hide('slow');          // Now hide the div.
            $('#show_more2').show();
        });
        
         $('#show_more3').click(function () {
            // Animate the div element. A duration is set to 500 milliseconds.
            $("#third_p").animate({ height: '770px' }, 500);
            $('#show_more3').hide();
            $('#third').show();          // Also show the div element.
        });

        // Reverse animate.
        $('#less_more3').click(function () {
            $("#third_p").animate({ height: '520px' }, 500);
            $('#third').hide('slow');          // Now hide the div.
            $('#show_more3').show();
        });
